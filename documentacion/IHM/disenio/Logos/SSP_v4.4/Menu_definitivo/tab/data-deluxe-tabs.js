...
//--- Tabs Images
var bitemBackImage=["deluxe-tabs.files/styleFF_n_back.gif","deluxe-tabs.files/styleFF_o_back.gif","deluxe-tabs.files/styleFF_s_back.gif"];
var bbeforeItemImage=["deluxe-tabs.files/styleFF_n_left.gif","deluxe-tabs.files/styleFF_o_left.gif","deluxe-tabs.files/styleFF_s_left.gif"];
var bafterItemImage=["deluxe-tabs.files/styleFF_n_right.gif","deluxe-tabs.files/styleFF_o_right.gif","deluxe-tabs.files/styleFF_s_right.gif"];
var bbeforeItemImageW=10;
var bbeforeItemImageH=27;
var bafterItemImageW=10;
var bafterItemImageH=27;
...
var bstyles = [
    ["bitemBackImage=","bbeforeItemImage=","bafterItemImage=","bitemBorderColor=#ffffff,#316AC5,#316AC5","bitemBorderWidth=1","bitemBackColor=#ffffff,#bbccee,#bbccee","bitemBorderStyle=solid,solid,solid"],
];
