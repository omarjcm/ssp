...
public class RegistroEclesiastico {
     ...
     */
    private String id_registro_eclesiastico;
    /**
    ...
    public RegistroEclesiastico() {
        this.lugar_bautizo = null;
        this.fecha_bautizo = new java.util.Date();
    }
     ...
     * @return long
     */
    public String getIdRegistroEclesiastico() {
     ...
     */
    public void setIdRegistroEclesiastico(String id_registro_eclesiastico) {
