...
<html>
    <head>
        ...
        <title>SSP - Anular Acta de Matrimonio</title>
...
%>
        Anular Acta de Matrimonio</span></td>
...
%>
        <form name="ninguno">
            <div id="titulo">ANULAR  ACTA DE MATRIMONIO </div><br>
            <br>
            <fieldset>
              ...
              <tr>
                ...
                <fieldset>
                  <legend>B&uacute;squeda por fecha</legend>
                    ...
                    <button type="button" name="btn_fecha_matrimonio" id="btn_fecha_matrimonio" onclick="cal.select(document.PorFecha.fecha_matrimonio,'btn_fecha_matrimonio','yyyy-MM-dd'); return false;" title="Haga click aqu&iacute; para ingresar la fecha del Matimonio."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                    </p>
					<br>
					<br>
<div align="center">
...
%>
    <form name="Consultar" >
      <div id="titulo">ANULAR ACTA DE MATRIMONIO</div><br><br>
...
%>
	 <form name="Anular" method="post" action="matrimonioAnularBEAN.jsp">
        <div id="titulo">ANULACI&Oacute;N DE ACTA DE MATRIMONIO</div><br>
        <br>
        <fieldset>
            <legend>Datos Personales del Matrimonio</legend>
            <p>
                <label>Nombre(s) y Apellido(s) del esposo:</label>
                <label><%out.println(matrimonioBEAN.esposo.getNombre()+" "+matrimonioBEAN.esposo.getApellido());%></label>
            </p>
            <p>
                <label>Nombre(s) y Apellido(s) de la esposa:</label>
                <label><%out.println(matrimonioBEAN.esposa.getNombre()+" "+matrimonioBEAN.esposa.getApellido());%></label>
            </p>
            <p>
                <label>Fecha de Matrimonio:</label>
                <label><%out.println(matrimonioBEAN.getfecha_matrimonio());%></label>
            </p>
            <p>
                <label>Estado del Acta:</label>
                <label><% if(matrimonioBEAN.getEstado()) out.println("Habilitada"); else out.println("Inhabilitada");%></label>
            </p>
        </fieldset>
        <br>
        <br>
...
%><br>
    <table width="200" border="0">
      ...
      <tr>
        ...
        <td width="126"><div align="left">Se ha anulado el Acta de Matrimonio con &eacute;xito.</div></td>
      </tr>
      <tr>
...
%><br>
    ...
    <tr>
     ...
     <td width="126"><div align="left">Lo siento pero el Acta de Matrimonio seleccionada se encuentra anulada.</div></td>
    </tr>
    <tr>
     <td colspan="2"><div align="center"><br>
         <input name="btn_inicio" type="button" id="btn_inicio" value="Ir al inicio" onClick="javascript:window.location.href='matrimonio.jsp?id=1';">
