                    ...
                    <td width="476" height="441" valign="top">
                        <form name="Reporte">
                            ...
                            <table width="297" border="0" align="center">
                              ...
                              <tr>
                                <td width="103"><label>Elija una opci&oacute;n:</label></td>
                                <td width="184">
								<input name="radio_reporte" type="radio" onClick="mostrarMensual();" value="0" checked>
                                  Mensual</input>
								<input name="radio_reporte" type="radio" value="1" onClick="mostrarAnual();">
                                  Anual</input>        </td>
                              </tr>
                            </table>
                            <div id="anual">
                            <table width="297" border="0" align="center">
                                <tr>
                                    <td width="78"><label for="fecha_inicio">Fecha Inicio: </label></td>
                                    <td width="152"><input name="fecha_inicio" type="text" class="txt" id="fecha_inicio" value="aaaa-mm-dd" maxlength="10"/></td>
                                    <td width="53"><button type="button" name="btn_fecha_inicio" id="btn_fecha_inicio" onclick="cal.select(document.Reporte.fecha_inicio,'btn_fecha_inicio','yyyy-MM-dd'); return false;" title="Haga click aqu&iacute; para ingresar la fecha de inicio."><img src="../../imagenes/Calendar.gif" border="0"/></button></td>
                                </tr>
                                <tr>
                                    <td><label for="fecha_fin">Fecha Fin: </label></td>
                                    <td><input name="fecha_fin" type="text" class="txt" id="fecha_fin" value="aaaa-mm-dd" maxlength="10"/></td>
                            ...
                            <table width="297" border="0" align="center">
                              <tr>
                                <td width="78"><label for="label">Fecha: </label></td>
                                <td width="152"><input name="fecha" type="text" class="txt" value="aaaa-mm" maxlength="7"/></td>
                                <td width="53"><button type="button" name="btn_fecha" id="btn_fecha" onclick="cal_.showCalendar('btn_fecha'); return false;" title="Haga click aqu&iacute; para ingresar la fecha del mes y el a&ntilde;o correspondiente."><img src="../../imagenes/Calendar.gif" border="0"/></button></td>
                              </tr>
                            </table>
							</div>
