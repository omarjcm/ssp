...
var mensaje_01 = "¿Está seguro de volver a iniciar la modificación del Acta de Primera Comunión?";
var mensaje_02 = "¿Está seguro de cancelar la modificación del Acta de Primera Comunión?";
...
function buscarPorFecha() {
	...
	if (!vacio(fecha)) {
		...
		document.PorFecha.fecha_comunion.focus();
	} else if (!validarFecha(fecha, "Primera Comunión")) {
		document.PorFecha.fecha_comunion.focus();
	} else {
