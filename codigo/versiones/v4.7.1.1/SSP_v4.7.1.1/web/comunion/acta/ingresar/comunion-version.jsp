...
<form name="comunion" method="post" action="comunionIngresarBEAN.jsp">
    ...
    <div id="menu_navegacion">
        <ul id="menu_lista">
            ...
            <li><a href="#" onClick="mostrar(1); return false;">&nbsp;&nbsp;&nbsp;&nbsp;Datos del Comulgado</a></li>
            <li><a href="#" onClick="mostrar(2); return false;">&nbsp;&nbsp;&nbsp;&nbsp;Datos del Comulgado</a></li>
    ...
    <div id="cont_solicitante_01">
        ...
        <table width="238" border="0">
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="2"><input name="id_sexo" type="radio" value="0" <%if (comunionBEAN.getcomulgado_sexo().compareTo("0") == 0) out.println("checked");%>> Femenino</input>
                <input name="id_sexo" type="radio" value="1" <%if (comunionBEAN.getcomulgado_sexo().compareTo("1") == 0) out.println("checked");%>> Masculino</input></td>
            </tr>
            <tr>
