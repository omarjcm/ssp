...
<%
              ...
              for (int i = 0; i < solicitanteList.size(); i++)
              {
                  ...
                  <a href="comunion_imprimir.jsp?id=<%=String.valueOf(solicitante.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550,menubar=yes'); return false;">
          ...
          <table width="300" border="0" class="datatable">
              <tr>
                  ...
                  for (int i = 0; i < comuniones.size(); i++)
                  {
                      ...
                      out.println("<tr><td> "+String.valueOf(i+1)+". "); %>
                      <a href="comunion_imprimir.jsp?id=<%=String.valueOf(comulgado.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550,menubar=yes'); return false;">
