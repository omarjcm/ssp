        ...
        <div id="Parroquia">
            <fieldset>
                ...
                <p>
                    ...
                    %>" maxlength="10"/>
                    <button type="button" name="btn_fecha_confirmacion" id="btn_fecha_confirmacion" onclick="cal.select(document.confirmar.fecha_confirmacion,'btn_fecha_confirmacion','yyyy-MM-dd'); return false;" title="Haga click aqu&iacute; para ingresar la fecha de la Confirmaci&oacute;n."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                </p>
            </fieldset>
	</div>
        <br>
        ...
        <div id="Solicitante">
            <fieldset>
              <legend>Datos del Confirmado</legend>
                ...
                <p>
                    <label for="id_sexo">Sexo: </label>
                    <input name="id_sexo" type="radio" value="0" <%if (confirmacionBEAN.getconfirmado_sexo().compareTo("0") == 0) out.println("checked");%>> Femenino</input>
                    <input name="id_sexo" type="radio" value="1" <%if (confirmacionBEAN.getconfirmado_sexo().compareTo("1") == 0) out.println("checked");%>> Masculino</input>
                </p>
                <p>
                  <label for="fecha_nacimiento">Fecha de Nacimiento: </label>
