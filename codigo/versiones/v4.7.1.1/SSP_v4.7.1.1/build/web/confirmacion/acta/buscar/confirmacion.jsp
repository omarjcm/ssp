      ...
      <form name="Consultar">
        ...
        <br>
          <table width="300" border="0" class="datatable">
              ...
              %>
              <a href="confirmacion_imprimir.jsp?tipo=1&id=<%=String.valueOf(solicitante.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550,menubar=yes'); return false;">
              ...
              <tr>
                  ...
                  for (int i = 0; i < confirmaciones.size(); i++)
                  {
                      confirmado = (SSP.Solicitante) confirmaciones.get(i);	
                                  out.println("<tr><td> "+String.valueOf(i+1)+". ");
                      %>
                      <a href="confirmacion_imprimir.jsp?id=<%=String.valueOf(confirmado.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550,menubar=yes'); return false;">
