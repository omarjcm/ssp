...
<%
    ...
    else if(uBEAN.validarUsuario(uBEAN.getUsuario(), uBEAN.getContrasenia(),"secretario") )
        response.sendRedirect("inicio/index.jsp");
    else if(uBEAN.validarUsuario(uBEAN.getUsuario(), uBEAN.getContrasenia(),"contador") )
            response.sendRedirect("inicio/index.jsp");
    else
