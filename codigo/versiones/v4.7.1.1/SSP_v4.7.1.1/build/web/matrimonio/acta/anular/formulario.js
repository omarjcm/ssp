var mensaje_01 = "¿Está seguro de volver a iniciar la anulación del Acta de Matrimonio?";
var mensaje_02 = "¿Está seguro de cancelar la anulación del Acta de Matrimonio?";
...
function irInicio()
{
	window.location.ref = "matrimonio.jsp";
}

function anularActa(Anular)
{
	var valor = confirm("¿Se encuentra seguro de anular el Acta de Matrimonio?");
	if (valor) {
		Anular.submit();
	}
}
