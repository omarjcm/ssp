        ...
        <fieldset>
            ...
            <p>
              ...
              <input name="fecha_matrimonio" type="text" id="fecha_matrimonio" class="txt" value="<%
                ...
                %>"/> 
              <button type="button" name="btn_fecha_matrimonio" id="btn_fecha_matrimonio" onclick="cal.select(document.casar.fecha_matrimonio,'btn_fecha_matrimonio','yyyy-MM-dd'); return false;" title="Haga click aqu&iacute; para ingresar la fecha del Matrimonio."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
            </p>
        </fieldset>
		</div>
        <br>
        ...
        <div id="Solicitante">
            <fieldset>
                ...
                <p>
                    ...
                    <input type="text" name="esposa_nombre" id="esposa_nombre" onKeyPress="return onlyChars(this)" class="txt" value="<%
                ...
                <p>
                    ...
                    <input type="text" name="esposa_apellido" id="esposa_apellido" onKeyPress="return onlyChars(this)" class="txt" value="<%
