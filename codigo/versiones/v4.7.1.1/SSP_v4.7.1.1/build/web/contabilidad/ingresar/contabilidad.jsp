											...
											<br>
												<table width="396" border="0" align="center">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td colspan="2"><input name="radio" id="radio1" type="radio" value="0" checked> Ingreso</input>
                                                    <input name="radio" id="radio2" type="radio" value="1"> Egreso interno</input>
                                                    <input name="radio" id="radio3" type="radio" value="2"> Egreso externo</input></td>
                                                  </tr>
                                                </table>
												<br>
											  </fieldset>
