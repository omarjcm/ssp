                                        ...
                                        <td height="251" colspan="5" valign="top">
                                            ...
                                            <fieldset>
                                                ...
                                                <p>
                                                    ...
                                                    <input name="lugar_bautizo" type="text" class="txt" id="lugar_bautizo" value="Parroquia Cristo Rey" title="Editar Lugar de Bautizo"/>
                                                </p>
                                                <p>
                                        ...
                                        <td height="251" colspan="6" valign="top">
                                            ...
                                            <fieldset>
                                                ...
                                                <p>
                                                    ...
                                                    <input name="lugar_nacimiento" type="text" class="txt" id="lugar_nacimiento" value="Guayaquil - Guayas"  title="Editar Lugar de Nacimiento"/>
                                                </p>
                                                <p>
                                        ...
                                        <td height="251" colspan="6" valign="top">
                                            ...
                                            <fieldset>
                                                ...
                                                <p>
                                                    ...
                                                    <input type="text" name="padre_apellido" id="padre_apellido" onKeyPress="return onlyChars(this)" class="txt" title="Editar Apellido(s) del padre"/>
                                                </p>
                                                <p>
                                                ...
                                                <p>
                                                    ...
                                                    <input type="text" name="madre_apellido" id="madre_apellido" onKeyPress="return onlyChars(this)" class="txt" title="Editar Apellido(s) de la madre"/>
                                                </p>
                                        </fieldset>            </td>
                                    </tr>
                                    <tr>
                        ...
                        <form name="bautismo" method="post" action="bautismoIngresarBEAN.jsp">
                                ...
                                <fieldset>
                                    ...
                                    <p>
                                        ...
                                        <input name="fecha_bautizo" type="text" id="fecha_bautizo" class="txt" value="<%
                                               ...
                                               %>"/> 
                                        <button type="button" name="btn_fecha_bautizo" id="btn_fecha_bautizo" onclick="cal.select(document.bautismo.fecha_bautizo,'btn_fecha_bautizo','yyyy-MM-dd'); return false;" title="Haga click aqu&iacute; para ingresar la Fecha de Bautizo."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                                    </p>
                                </fieldset>
                            </div>
                            <br>
                            ...
                            <div id="Solicitante">
                                <fieldset>
                                    ...
                                    <p>
                                        <label for="id_sexo">Sexo: </label>
                                        <input name="id_sexo" type="radio" value="0" <%if (bautizoBEAN.getbautizado_sexo().compareTo("0") == 0) out.println("checked");%>> Femenino</input>
                                        <input name="id_sexo" type="radio" value="1" <%if (bautizoBEAN.getbautizado_sexo().compareTo("1") == 0) out.println("checked");%>> Masculino</input>
                                    </p>
                                    <p>
                                        <label for="lugar_nacimiento">Lugar de Nacimiento: </label>
                                    ...
                                    <p>
                                        ...
                                        <input name="fecha_nacimiento" type="text" class="txt" id="fecha_nacimiento" value="<%
                                               ...
                                               %>"/>
                                        <button type="button" name="btn_fecha_nacimiento" id="btn_fecha_nacimiento" onclick="cal.select(document.bautismo.fecha_nacimiento,'btn_fecha_nacimiento','yyyy-MM-dd'); return false;" title="Haga click aqu&iacute; para ingresar la Fecha de Nacimiento."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                                    </p>
                                </fieldset>
                            </div>
                            <br>
                                ...
                                <fieldset>
                                    <p>
                                        ...
                                        <input name="anio_libro" type="text" id="anio_libro" onKeyUp="onlyNumbers(this);" maxlength="4" class="txt" value="<%
                                               ...
                                               %>"/>
                                        <button type="button" name="btn_anio_libro" id="btn_anio_libro" onclick="cal_anio_01b.showCalendar('btn_anio_libro'); return false;" title="Haga click aqu&iacute; para ingresar el a&ntilde;o del Libro de Bautizo."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                                    </p>
                                    <p>
                                        <label for="num_sacramento">No: </label>
                                ...
                                <fieldset>
                                    <p>
                                        ...
                                        <input type="text" name="anio" id="anio" class="txt" value="<%
                                               ...
                                               %>" onKeyUp="onlyNumbers(this);" maxlength="4" />
                                        <button type="button" name="btn_anio" id="btn_anio" onclick="cal_anio_02b.showCalendar('btn_anio'); return false;" title="Haga click aqu&iacute; para ingresar el a&ntilde;o del Libro del Registro Civil."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                                    </p>
                                    <p>
                                        <label for="acta">Acta: </label>
