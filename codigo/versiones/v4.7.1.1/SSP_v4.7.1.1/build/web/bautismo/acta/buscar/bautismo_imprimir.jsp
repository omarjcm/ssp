    ...
    <th scope="row"><table width="614" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="341" valign="top">
			<div id="imp_titulo">Certificado de Bautismo</div>
        </td>
        <td width="20">&nbsp;</td>
      </tr>
      <tr>
...
%>
  ...
  <tr>
    <th scope="row"><input name="btn_imprimir" type="button" id="btn_imprimir" value="Imprimir" onClick="javascript:window.print();">&nbsp;&nbsp;&nbsp;
