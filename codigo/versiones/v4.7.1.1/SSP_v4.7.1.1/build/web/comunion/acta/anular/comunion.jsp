...
%>
        Anular Acta de Primera Comuni&oacute;n</span> </td>
...
%>
      <form name="Consultar">
        <div id="titulo">ANULAR ACTA DE PRIMERA COMUNI&Oacute;N</div>
        <br><br>
        <br>
          <table width="300" border="0" class="datatable">
              <tr>
...
<%    
		...
		//out.println(id_comulgado);
        if (id_comulgado != null) {
            if (tipo != null)
                comunionBEAN.comulgado.setIdSolici(id_comulgado);
            comunionBEAN.consultarDatosComunion(id_comulgado);
%>
	<form name="Anular" method="post" action="comunionAnularBEAN.jsp">
        <div id="titulo">ANULACI&Oacute;N DE ACTA DE PRIMERA COMUNI&Oacute;N</div>
        <br>
        <br>
        <fieldset>
            ...
            <p>
                <label>Fecha de Comuni&oacute;n:</label>
