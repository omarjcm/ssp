 ...
 *   4.6        Vanessa Izquierdo   15/07/07  Ingresar Bautizo
 *   4.7        Vanessa Izquierdo   20/07/07  Modificar Bautizo
 *   4.7        Vanessa Izquierdo   20/07/07  Anular Bautizo
 * ==============================================================
 *
 */
package SSP;
...
public class Bautizar {
    ...
    /**
     * identifica al acta de bautizo
     *
     * <p>requisito: RD-MD.1.1
     */
    ...
    /**
     * Muestra el nombre del ministro.
     */
    public String ministro_nya;
    /**
     * Muestra los datos del objeto bautizado.
     */
    public Solicitante bautizado;
    /**
     * Muestra los datos del objeto padre.
     */
    public Solicitante padre;
    /**
     * Muestra los datos del objeto madre.
     */
    public Solicitante madre;
    /**
     * Muestra los datos del objeto padrino.
     */
    public Solicitante padrino;
    /**
     * Muestra los datos del objeto madrina.
     */
    ...
    /**
     * Muestra los datos del objeto registro eclesiástico.
     */
    public RegistroEclesiastico re;
    /**
     * Muestra dato de sexo.
     */
    public String sex;
    /**
    ...
    /**
     * Muestra los datos del objeto conexiónDB.
     */
    ...
    /*CONSTRUCTORES*/
    /**
     * Constructor que crea una instancia Bautizo.
     * <p>requisito: RD-MD.1.1
     */
  ...
  /**
  * Genera la lista de los bautizados en la fecha ingresada
  * Datos.
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Ingresar Acta
  * <p>Poscondiciones:
  * @param fecha		Fecha de Bautizo
  ...
  */
   ...
   /**
  * Indica si se ingresó o no el acta de Bautizo
  * 
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Enviar datos  para el ingreso de Acta
  * <p>Poscondiciones:
...
/**
  * Genera la la consulta de los datos del acta del Bautizo
  * 
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Ingresar Acta
  * <p>Poscondiciones:
  * @param id   		identificador del acta de bautizo
  * @return 			void
  */
  ...
  /**
  * Busca el identificador del acta de bautizo
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Ingresar Acta
  * <p>Poscondiciones:
  * @param id_  		identificador del acta de bautizo
  ...
  */
  ...
  /**
  * Actualizar datos bautizo
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Ingresar Acta
  * <p>Poscondiciones:
  * @param id_usuario		identificador del acta de bautizo
  * @return 			boolean
  */
  ...
  /**
  * Anular acta de Bautizo
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Ingresar Acta Bautizo
  * <p>Poscondiciones:
  * @param id_		identificador de acta de Bautizo
  * @param doc		Tipo de documento
  * @return 		boolean
  */  
