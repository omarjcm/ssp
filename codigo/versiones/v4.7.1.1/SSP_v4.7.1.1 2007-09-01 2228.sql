...
INSERT INTO `registro` (`id_registro`,`fecha`,`valor`,`tipo`,`descripcion`,`id_contador`) VALUES 
 (1,'2007-08-25',45,'Egreso Interno','Sueldo',3),
 (2,'2007-08-25',45,'Ingreso','Limosna',3),
 (4,'2007-08-25',123,'Egreso Interno','Sueldo',12),
 (5,'2007-08-25',25,'Egreso Interno','Sueldo',12),
 (6,'2007-08-25',230,'Egreso Interno','Sueldo',3),
 (7,'2007-08-25',45,'Egreso Interno','Sueldo',3),
 (8,'2007-08-25',23,'Egreso Interno','Sueldo',3),
 (9,'2007-08-25',23,'Egreso Interno','Sueldo',3),
 (10,'2007-08-29',100,'Ingreso','ve',3),
 (11,'2007-08-28',200,'Egreso Externo','vr',3),
 (12,'2007-09-01',45,'Egreso Interno','Sueldos',3);
...
INSERT INTO `usuario` (`id_usuario`,`nombre`,`apellido`,`direccion`,`tipo`,`cargo`,`telefono1`,`telefono2`,`usuario`,`contrasenia`,`estado`,`id_administrador`) VALUES 
 ...
 (13,'Julio','Macías','Sauces 9','Administrador','Sr.','2564748','','julio','12345',1,3);
...
BEGIN
  ...
  SET AUTOCOMMIT= 0;
  -- CALL ssp_existe_registro(fecha, salida);
...
/*  IF(salida = 'si') THEN
  ...
  ELSE*/
    ...
    VALUES (fecha, valor, tipo, descripcion, id_contador);
