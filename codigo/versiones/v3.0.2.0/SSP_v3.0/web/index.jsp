...
<table width="765" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td height="303" colspan="2" valign="top"><p>&nbsp;</p>
      ...
      <form name="Usuario" method="post" action="sesion.jsp">
        <table width="200" border="0" align="center">
          <tr>
            <td colspan="2"><div align="center" class = "titulo">Acceso </div>              <br>
            </td>
          </tr>
          <tr valign="middle">
          ...
          <tr>
            <td colspan="2"><div align="center"><a style="cursor:pointer; font-weight: bold; color: #0000FF; font-size: 10pt;" onclick="validarUsuario(Usuario)"><br>Aceptar</a></div></td>
          </tr>
        </table>
      </form>            
    </td>
  ...
  <tr>
    <td height="30" colspan="2" align="center" valign="middle"background="imagenes/spacer_down.gif"><div align="center">&quot;Sistemas de Servicios Parroquiales&quot; (SSP)</div></td>
  </tr>
</table>
</body>
</html>
