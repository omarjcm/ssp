...
nomP_ VARCHAR(50), apeP_ VARCHAR(50), sexoP_ BOOLEAN, tipoP_ VARCHAR(50),
nomM_ VARCHAR(50), apeM_ VARCHAR(50), sexoM_ BOOLEAN,
tipoM_ VARCHAR(50), nomPa_ VARCHAR(50), apePa_ VARCHAR(50),
sexoPa_ BOOLEAN, tipoPa_ VARCHAR(50), nomMa_ VARCHAR(50), apeMa_ VARCHAR(50),
sexoMa_ BOOLEAN, tipoMa_ VARCHAR(50), tomo_ VARCHAR(50), anio_ VARCHAR(50),
...
id_usuario BIGINT, num_sacramento_ VARCHAR(50), num_libro_ VARCHAR(50), folio_libro_ VARCHAR(50), anio_libro_ VARCHAR(50),
lugar_bautizo_ VARCHAR(50), fecha_bautizo_ DATE, iglesia_bautizo_ VARCHAR(50), arquidiocesis_ VARCHAR(50), es_acta_ BOOLEAN,
  ...
  ELSE
    ...
    SET counter=2;
     ...
     --   BEGIN
        ...
        CALL ssp_ingresar_solicitante(nomP_, apeP_, '', null, '', '', sexoP_, null, null, '', '', tipoP_, salida);
        SET counter=7;
        #Ingresa madre del bautizado
        CALL ssp_ingresar_solicitante(nomM_, apeM_, '', null, '', '', sexoM_, null, null, '', '', tipoM_, salida);
        SET counter=8;
        #Ingresa padrino del bautizado
        SET counter=9;
        CALL ssp_ingresar_solicitante(nomPa_, apePa_, '', null, '', '', sexoPa_, null, null, '', '', tipoPa_, salida);
      --  counter=10;
        #Ingresa madrina del bautizado
        CALL ssp_ingresar_solicitante(nomMa_, apeMa_, '', null, '', '', sexoMa_, null, null, '', '', tipoMa_, salida);
        SET counter=11;
        ...
        INSERT INTO Bautizar(observacion, estado, id_bautizado, id_padre, id_madre, id_padrino, id_madrina, id_registro_civil, id_ministro, id_usuario, id_registro_eclesiastico)
	      VALUES (observacion_, estado_, id_bautizado, id_padre, id_madre, id_padrino, id_madrina, id_registro_civil, id_ministro, id_usuario,
