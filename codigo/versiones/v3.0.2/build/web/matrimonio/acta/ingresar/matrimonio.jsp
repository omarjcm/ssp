...
<table width="550" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <br>
        ...
        <table width="87%"  border="0" align="center">
          <tr>
            <th width="55%" scope="col">
              <div class = "etiqueta"> Nombre(s) del padrino: </div></th>
            <th width="45%" align="right" valign="middle" scope="col">
              <div align="left">
          ...
          <tr>
            <th scope="row"><div class = "etiqueta"> Apellido(s) del padrino: </div></th>
            <td align="right" valign="middle">
              <div align="left">
  ...
  <br>
        ...
        <table width="87%"  border="0" align="center">
          <tr>
            <th scope="row"><a onclick="validar(Matrimonio)" style="cursor:pointer; font-weight: bold; color: #0000FF;">Aceptar</a></th>
          </tr>
        </table>
        <p>&nbsp;</p>
    </form></td>
