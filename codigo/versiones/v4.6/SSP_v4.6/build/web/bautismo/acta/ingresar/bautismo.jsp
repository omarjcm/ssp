    ...
    <td height="312" valign="top">
	  ...
	  <div id="reg_eclesiastico">
		...
		<table width="500" border="0" align="center">
          <tr>
            <td width="250">&nbsp;</td>
            <td width="250" align="right"><a id="titulo" href="#" onclick="mostrarParroquia(Bautizo)">Siguiente</a></td>
          </tr>
        </table>
	  </div>
		<div id="parroquia">
		...
		<table width="500" border="0" align="center">
          <tr>
            <td width="255" align="left"><a id="titulo" href="#" onclick="mostrarRegistroEclesiastico()">Anterior</a></td>
            <td width="255" align="right"><a id="titulo" href="#" onclick="mostrarSolicitante()">Siguiente</a></td>
          </tr>
        </table>
		</div>
		<div id="solicitante">
		...
		<table width="500" border="0" align="center">
          <tr>
            <td width="250" align="left"><a id="titulo" href="#" onclick="mostrarParroquia()">Anterior</a></td>
            <td width="250" align="right"><a id="titulo" href="#" onclick="mostrarPadres()">Siguiente</a></td>
          </tr>
        </table>
		</div>
		<div id="padres">
		...
		<table width="500" border="0" align="center">
          <tr>
            <td width="250" align="left"><a id="titulo" href="#" onclick="mostrarSolicitante()">Anterior</a></td>
            <td width="250" align="right"><a id="titulo" href="#" onclick="mostrarPadrinos()">Siguiente</a></td>
          </tr>
        </table>
		</div>
		<div id="padrinos">
		...
		<table width="500" border="0" align="center">
          <tr>
            <td width="250" align="left"><a id="titulo" href="#" onclick="mostrarPadres()">Anterior</a></td>
            <td width="250" align="right"><a id="titulo" href="#" onclick="mostrarRegistroCivil()">Siguiente</a></td>
          </tr>
        </table>
		</div>
		<div id="reg_civil">
		...
		<table width="500" border="0" align="center">
          <tr>
            <td width="250" align="left"><a id="titulo" href="#" onclick="mostrarPadrinos()">Anterior</a></td>
            <td width="250" align="right"><a id="titulo" href="#" onclick="mostrarObservacion()">Siguiente</a></td>
          </tr>
        </table>
		</div>
		...
		<table width="500" border="0" align="center">
          <tr>
            <td width="250" align="left"><a id="titulo" href="#" onclick="mostrarRegistroCivil()">Anterior</a></td>
            <td width="250">&nbsp;</td>
          </tr>
        </table>
		<br>
