    ...
    <td height="303" colspan="2" valign="top"><p>&nbsp;</p>
      <p>&nbsp;</p>
        <table width="367" border="0" align="center" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
          <tr>
            <td width="369" height="22" align="center" valign="middle" background="../imagenes/ctop.gif"><div id="titulo_lema"></div></td>
          </tr>
          <tr>
            <td height="121" align="center" valign="middle"background="../imagenes/ccen.gif"><div id="lema">Su usuario y/o contrase&ntilde;a no son v&aacute;lidos.<br>
                <br>                
                Vuelva a intentar<br>
                <br>
                <br>
                <a href="../menu/index.jsp">OK</a>               </div></td>
          </tr>
          <tr>
