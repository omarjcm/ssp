...
<html>
    ...
    <table width="770" border="0" align="left">
      ...
      <tr>
        <td height="10" valign="middle"><a href="../../../menu/index.jsp">Inicio</a> &gt; <span id="titulo">Ingreso de Acta de Matrimonio</span></td>
      </tr>
      <tr>
        <td height="391" colspan="3" align="center" valign="top">
            <div id="tabsB">
                <ul>
                    ...
                    <li  id="current"><a href="matrimonio.jsp"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matrimonio&nbsp;&nbsp;</span></a></li>
                </ul>
            </div>
<br>
<br>
...
<table width="570" border="0">
  <tr>
    <td height="14" valign="top" align="center"><span id="titulo"><strong>ACTA DE MATRIMONIO </strong></span></td>
  </tr>
  <tr>
    <td width="434" height="356" valign="top">
	  <form name="Bautizo" method="post" action="matrimonioBEAN.jsp">
