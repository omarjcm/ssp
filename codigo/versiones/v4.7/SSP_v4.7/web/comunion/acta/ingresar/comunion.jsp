...
<html>
    ...
    <table width="770" border="0" align="left">
      ...
      <tr>
        <td height="10" valign="middle"><a href="../../../menu/index.jsp">Inicio</a> &gt; <span id="titulo">Ingreso de Acta de Primera Comuni&oacute;n </span> </td>
      </tr>
      <tr>
        <td height="391" colspan="3" align="center" valign="top">
            <div id="tabsB">
                <ul>
                    ...
                    <li id="current"><a href="comunion.jsp"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Primera Comuni&oacute;n&nbsp;&nbsp;</span></a></li>
...
<table width="570" border="0">
  <tr>
    <td height="14" valign="top" align="center"><span id="titulo"><strong>ACTA DE PRIMERA COMUNI&Oacute;N</strong></span></td>
  </tr>
  <tr>
    <td width="434" height="356" valign="top">
	  <form name="Bautizo" method="post" action="comunionBEAN.jsp">
	  <div id="reg_eclesiastico">
		...
		<table width="500" border="0" align="center">
          <tr>
            <td align="center">
              <input type="button" name="Button" value="Guardar" onclick="vistaPrevia()">			</td>
          </tr>
        </table>
		</div>
    </form>	</td>
