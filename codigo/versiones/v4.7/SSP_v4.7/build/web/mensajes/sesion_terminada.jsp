    ...
    <td height="303" colspan="2" valign="top"><p>&nbsp;</p>
      <p>&nbsp;</p>
        <table width="367" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="103" align="center" valign="middle"background="../imagenes/ccen.gif"><div id="lema">
              <p>Su sesi&oacute;n ha terminado.</p>
              <p>Por favor, ingrese otra vez...  <br>
                <br>
                <br>
                <a href="../menu/index.jsp">OK</a> </p>
            </div></td>
          </tr>
          <tr>
