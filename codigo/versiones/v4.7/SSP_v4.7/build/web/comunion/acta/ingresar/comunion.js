...
function validar(F){
	 ...
	 */
	if((!vacio(F.padrino_nombre.value) && !vacio(F.padrino_apellido.value)) && 
	   (!vacio(F.madrina_nombre.value) && !vacio(F.madrina_apellido.value))){
		alert("Debe ingresar al menos el NOMBRE y el APELLIDO de un PADRINO.")
		return false
	}
	else{
		  ok()
