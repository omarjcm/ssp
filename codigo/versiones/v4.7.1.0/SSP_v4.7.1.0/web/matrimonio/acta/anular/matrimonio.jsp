...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="matrimonio.jsp">Anular Acta</a>			<br>
<%
		}
	}
%>							
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Anular Acta de Matrimonio </td>
      ...
      <tr>
        <td width="580" height="321" align="center" valign="top">			
            <ul id="tabnav">
                ...
                <li><a href="../../../confirmacion/acta/anular/confirmacion.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Confirmaci&oacute;n&nbsp;&nbsp;</a></li>
      ...
      <table width="450" border="0" align="center">
          <tr>
              ...
              for (int i = 0; i < esposoList.size(); i++)
              {
                  ...
                  out.println("<tr><td>");
                  %>
                  <a href="matrimonio.jsp?id=3&tipo=1&nom01=<%=String.valueOf(esposo.getNombre())%>&ape01=<%=String.valueOf(esposo.getApellido())%>&nom02=<%=String.valueOf(esposa.getNombre())%>&ape02=<%=String.valueOf(esposa.getApellido())%>">
      ...
      <table width="450" border="0" align="center">
        ...
        <%
            ...
            for (int i = 0; i < matrimonios.size(); i++)
            {
                ...
                out.println("<tr><td>");%>
                <a href="mostrar_consulta.jsp?id=<%=String.valueOf(matrimonio.getIdMatrimonio())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
