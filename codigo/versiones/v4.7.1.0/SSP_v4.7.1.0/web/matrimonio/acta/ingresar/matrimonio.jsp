...
%>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="matrimonio.jsp">Ingresar Acta</a><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="../buscar/matrimonio.jsp">Buscar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%
...
%>		  
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Ingreso de Acta de Matrimonio</td>
      ...
      <tr>
        <td width="580" height="321" align="center" valign="top">			
            <ul id="tabnav">
                ...
                <li><a href="matrimonio.jsp" class="active"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matrimonio&nbsp;&nbsp;</span></a></li>
            </ul>
      <div id="container">
<%
    if (id != null && id.compareTo("1") == 0) {
        ...
        <div id="parroquia">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <button type="button" name="btn_fecha_matrimonio" id="btn_fecha_matrimonio" onclick="cal.select(document.Matrimonio.fecha_matrimonio,'btn_fecha_matrimonio','yyyy-MM-dd'); return false;" title="cal.select(document.Matrimonio.fecha_matrimonio,'btn_fecha_matrimonio','yyyy-MM-dd'); return false;"><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                </p>
            </fieldset>
            </td>
            </tr>
            ...
            <div id="titulo_paso">Paso 3 de 8</div>
              <fieldset>
                ...
                <p>
                  ...
                  <input type="text" name="pa_esposo_nombre" id="pa_esposo_nombre" class="txt"/>
                </p>
                <p>
                  <label for="pa_esposo_apellido">Apellido(s) del padre: </label>
                  <input type="text" name="pa_esposo_apellido" id="pa_esposo_apellido" class="txt"/>
                </p>
                <p>
                  <label for="ma_esposo_nombre">Nombre(s) de la madre: </label>
                  <input type="text" name="ma_esposo_nombre" id="ma_esposo_nombre" class="txt"/>
                </p>
                <p>
                  <label for="ma_esposo_apellido">Apellido(s) de la madre: </label>
                  <input type="text" name="ma_esposo_apellido" id="ma_esposo_apellido" class="txt"/>
                </p>
            </fieldset>
            </td>
            </tr>
        ...
        <div id="padres_esposa">
	      ...
	      <legend>Datos de los Padres de la Esposa</legend>
                <p>
                  ...
                  <input type="text" name="pa_esposa_nombre" id="pa_esposa_nombre" class="txt"/>
                </p>
                <p>
                  <label for="pa_esposa_apellido">Apellido(s) del padre: </label>
                  <input type="text" name="pa_esposa_apellido" id="pa_esposa_apellido" class="txt"/>
                </p>
                <p>
                  <label for="ma_esposa_nombre">Nombre(s) de la madre: </label>
                  <input type="text" name="ma_esposa_nombre" id="ma_esposa_nombre" class="txt"/>
                </p>
                <p>
                  <label for="ma_esposa_apellido">Apellido(s) de la madre: </label>
                  <input type="text" name="ma_esposa_apellido" id="ma_esposa_apellido" class="txt"/>
                </p>
            </fieldset>
            </td>
            </tr>
	...
	<div id="reg_civil">
          <table width="449" height="278" border="0" cellpadding="0" cellspacing="0">
            ...
            <p>
                    ...
                    <button type="button" name="btn_fecha_inscripcion" id="btn_fecha_inscripcion" onclick="cal.select(document.Matrimonio.rc_fecha_inscripcion,'btn_fecha_inscripcion','yyyy-MM-dd'); return false;" title="cal.select(document.Matrimonio.rc_fecha_inscripcion,'btn_fecha_inscripcion','yyyy-MM-dd'); return false;"><img src="../../../imagenes/Calendar.gif" border="0"/></button>
            </p>
            <p>
        ...
        <div id="txt_observacion">
          <table width="449" height="278" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="500" border="0" align="center">
              <tr>
                <td align="center">
                  <input type="submit" name="Submit" value="Guardar" onclick="validar(Matrimonio)">
                </td>
              </tr>
            </table>
          </div>
      ...
      <form name="casar" method="post" action="matrimonioIngresarBEAN.jsp">
        ...
        <fieldset>
            ...
            <p>
              ...
              <input name="fecha_matrimonio" type="text" id="fecha_matrimonio" class="txt" value="<%
                ...
                %>"/> 
              <button type="button" name="btn_fecha_matrimonio" id="btn_fecha_matrimonio" onclick="cal.select(document.casar.fecha_matrimonio,'btn_fecha_matrimonio','yyyy-MM-dd'); return false;" title="cal.select(document.casar.fecha_matrimonio,'btn_fecha_matrimonio','yyyy-MM-dd'); return false;"><img src="../../../imagenes/Calendar.gif" border="0"/></button>
            </p>
        </fieldset>
		</div>
        <br>
        ...
        <div id="Solicitante">
            <fieldset>
                <p>
                    <label for="esposo_nombre">Nombre(s) del esposo: </label>
                    <input type="text" name="esposo_nombre" id="esposo_nombre" class="txt" value="<%
                ...
                <p>
                    <label for="esposo_apellido">Apellido(s) del esposo: </label>
                    <input type="text" name="esposo_apellido" id="esposo_apellido" class="txt" value="<%
                ...
                <p>
                    ...
                    <input type="text" name="esposa_nombre" id="esposa_nombre" class="txt" value="<%
                ...
                <p>
                    ...
                    <input type="text" name="esposa_apellido" id="esposa_apellido" class="txt" value="<%
        ...
        <div id="Padres_Esposo">
            <fieldset>
                <p>
                  <label for="pa_esposo_nombre">Nombre(s) del padre: </label>
                  <input type="text" name="pa_esposo_nombre" id="pa_esposo_nombre" class="txt" value="<%
                ...
                <p>
                  <label for="pa_esposo_apellido">Apellido(s) del padre: </label>
                  <input type="text" name="pa_esposo_apellido" id="pa_esposo_apellido" class="txt" value="<%
                ...
                <p>
                  <label for="ma_esposo_nombre">Nombre(s) de la madre: </label>
                  <input type="text" name="ma_esposo_nombre" id="ma_esposo_nombre" class="txt" value="<%
                ...
                <p>
                  <label for="ma_esposo_apellido">Apellido(s) de la madre: </label>
                  <input type="text" name="ma_esposo_apellido" id="ma_esposo_apellido" class="txt" value="<%
        ...
        <div id="Padres_Esposa">
            <fieldset>
                <p>
                  <label for="pa_esposa_nombre">Nombre(s) del padre: </label>
                  <input type="text" name="pa_esposa_nombre" id="pa_esposa_nombre" class="txt" value="<%
                ...
                <p>
                  <label for="pa_esposa_apellido">Apellido(s) del padre: </label>
                  <input type="text" name="pa_esposa_apellido" id="pa_esposa_apellido" class="txt" value="<%
                ...
                <p>
                  <label for="ma_esposa_nombre">Nombre(s) de la madre: </label>
                  <input type="text" name="ma_esposa_nombre" id="ma_esposa_nombre" class="txt" value="<%
                ...
                <p>
                  <label for="ma_esposa_apellido">Apellido(s) de la madre: </label>
                  <input type="text" name="ma_esposa_apellido" id="ma_esposa_apellido" class="txt" value="<%
        ...
        <div id="Registro_civil">
            <fieldset>
                <p>
                  ...
                  %>" maxlength="10"/>
                  <button type="button" name="btn_fecha_inscripcion" id="btn_fecha_inscripcion" onclick="cal.select(document.casar.rc_fecha_inscripcion,'btn_fecha_inscripcion','yyyy-MM-dd'); return false;" title="cal.select(document.casar.rc_fecha_inscripcion,'btn_fecha_inscripcion','yyyy-MM-dd'); return false;"><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                </p>
                <p>
                  <label for="acta">Acta: </label>
...
%>
    <table width="200" border="0">
      ...
      <tr>
        <td colspan="2"><div align="center"><a href="matrimonio.jsp?id=1">OK</a></div></td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
      </tr>
