...
<html>
    <head>
        ...
        <title>SSP - Buscar Acta de Primera Comuni&oacute;n</title>
...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="comunion.jsp?id=1">Buscar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%
...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="../anular/comunion.jsp?id=1">Anular Acta</a>			<br>			
                <%
		}
	}
%></td>
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Buscar Acta de Primera Comuni&oacute;n</td>
      ...
      <tr>
        <td width="580" height="321" align="center" valign="top">			
            <ul id="tabnav">
                <li><a href="../../../bautismo/acta/buscar/bautismo.jsp?id=1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bautizo&nbsp;&nbsp;</a></li>
                <li><a href="comunion.jsp?id=1" class="active">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Primera Comuni&oacute;n&nbsp;&nbsp;</a></li>
                <li><a href="../../../confirmacion/acta/buscar/confirmacion.jsp?id=1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Confirmaci&oacute;n&nbsp;&nbsp;</a></li>
                <li><a href="../../../matrimonio/acta/buscar/matrimonio.jsp?id=1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matrimonio&nbsp;&nbsp;</a></li>
            </ul>
      <div id="container">
<%
...
%>
        <form name="ninguno">
            <div id="titulo">BUSCAR  ACTA DE PRIMERA COMUNI&Oacute;N</div></a><br>
            <br>
            <fieldset>
...
%>
      <form name="Consultar">
        <div id="titulo">BUSCAR ACTA DE PRIMERA COMUNI&Oacute;N</div><br><br>
        <br>
...
<%
              ...
              for (int i = 0; i < solicitanteList.size(); i++)
              {
                  ...
                  out.println("<tr><td>"); %>
                  <a href="comunion_imprimir.jsp?id=<%=String.valueOf(solicitante.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
...
%>
      <form name="Consultar">
        <div id="titulo">BUSCAR ACTA DE BAUTIZO</div><br><br>
        <br>
          <table width="300" border="0">
              <tr>
                  <td>
                  ...
                  for (int i = 0; i < comuniones.size(); i++)
                  {
                      ...
                      out.println("<tr><td>"); %>
                      <a href="comunion_imprimir.jsp?id=<%=String.valueOf(comulgado.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
