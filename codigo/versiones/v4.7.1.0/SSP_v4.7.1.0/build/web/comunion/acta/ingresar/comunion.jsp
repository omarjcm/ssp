...
%>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="comunion.jsp?id=1">Ingresar Acta</a><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Ingreso de Acta de Primera Comuni&oacute;n </td>
      ...
      <tr>
        <td width="580" height="321" align="center" valign="top">			
            <ul id="tabnav">
                ...
                <li><a href="comunion.jsp?id=1" class="active"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Primera Comuni&oacute;n&nbsp;&nbsp;</span></a></li>
                <li><a href="../../../confirmacion/acta/ingresar/confirmacion.jsp?id=1"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Confirmaci&oacute;n&nbsp;&nbsp;</span></a></li>
      ...
      <form name="Comunion" method="post" action="comunionIngresarBEAN.jsp">
        ...
        <div id="Solicitante">
            <fieldset>
                    ...
                    <p>
                        <label for="id_sexo">Sexo: </label>
                        <label ><input name="id_sexo" type="radio" value="0" <%if (comunionBEAN.getcomulgado_sexo().compareTo("0") == 0) out.println("checked");%>> Femenino</label>
                        <label ><input name="id_sexo" type="radio" value="1" <%if (comunionBEAN.getcomulgado_sexo().compareTo("1") == 0) out.println("checked");%>> Masculino</label>
                    </p>
                    <p>
                      <label for="fecha_nacimiento">Fecha de Nacimiento: </label>
