...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Modificar Acta de Primera Comuni&oacute;n </td>
      ...
      <tr>
        <td width="580" height="321" align="center" valign="top">			
            <ul id="tabnav">
                <li><a href="../../../bautismo/acta/modificar/bautismo.jsp?id=1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bautizo&nbsp;&nbsp;</a></li>
...
%>
        <form name="Consultar">
        <div id="titulo">MODIFICAR ACTA DE BAUTIZO</div><br><br>
        <br>
          <table width="300" border="0">
              <tr>
                  <td>
