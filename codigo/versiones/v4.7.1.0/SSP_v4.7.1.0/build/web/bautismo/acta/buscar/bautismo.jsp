...
<html>
    <head>
        ...
        <title>SSP - Buscar Acta de Bautizo</title>
...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="bautismo.jsp?id=1">Buscar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Buscar Acta de Bautizo</td>
      ...
      <tr>
        <td width="580" height="321" align="center" valign="top">			
            <ul id="tabnav">
                ...
                <li><a href="../../../comunion/acta/buscar/comunion.jsp?id=1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Primera Comuni&oacute;n&nbsp;&nbsp;</a></li>
...
<%
              ...
              for (int i = 0; i < solicitanteList.size(); i++)
              {
                  ...
                  out.println("<tr><td>"); %>
                  <a href="bautismo_imprimir.jsp?id=<%=String.valueOf(solicitante.getIdSolicitante()+"&tipo=1")%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
          ...
          <table width="300" border="0">
              <tr>
                  ...
                  for (int i = 0; i < bautizos.size(); i++)
                  {
                      ...
                      out.println("<tr><td>"); %>
                      <a href="bautismo_imprimir.jsp?id=<%=String.valueOf(bautizado.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
