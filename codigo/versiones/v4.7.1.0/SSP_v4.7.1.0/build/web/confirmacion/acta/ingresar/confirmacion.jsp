...
%>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="confirmacion.jsp?id=1">Ingresar Acta</a><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="../buscar/confirmacion.jsp?id=1">Buscar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%
		if (uBEAN.esAdministrador()==true)
		{
%>
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="../modificar/confirmacion.jsp?id=1">Modificar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="../anular/confirmacion.jsp?id=1">Anular Acta</a>			<br>			<%
		}
	}
%></td>
          </tr>
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Ingreso de Acta de Confirmaci&oacute;n </td>
      ...
      <tr>
        <td width="580" height="321" align="center" valign="top">			
            <ul id="tabnav">
                <li><a href="../../../bautismo/acta/ingresar/bautismo.jsp?id=1"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bautizo&nbsp;&nbsp;</span></a></li>
                <li><a href="../../../comunion/acta/ingresar/comunion.jsp?id=1"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Primera Comuni&oacute;n&nbsp;&nbsp;</span></a></li>
                <li><a href="confirmacion.jsp" class="active"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Confirmaci&oacute;n&nbsp;&nbsp;</span></a></li>
                <li><a href="../../../matrimonio/acta/ingresar/matrimonio.jsp?id=1"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matrimonio&nbsp;&nbsp;</span></a></li>
                ...
                <fieldset>
                  <legend>Datos del Confirmado</legend>
                    ...
                    <p>
                      ...
                      <label><input name="id_sexo" type="radio" value="0" checked>Femenino</label>
...
%>
      <form name="confirmar" method="post" action="confirmacionIngresarBEAN.jsp">
        ...
        <div onclick="show('Parroquia')">
          <a href="#name" onclick="return false">Datos de la Parroquia</a>
        </div>
        <div id="Parroquia">
            <fieldset>
                <legend>Datos de la Parroquia</legend>
                ...
                <p>
                      <label for="lugar_confirmacion">Lugar de Confirmaci&oacute;n: </label>
                      <input name="lugar_confirmacion" type="text" class="txt" id="lugar_confirmacion" value="<%
                ...
                <p>
                    <label for="fecha_confirmacion">Fecha de Confirmaci&oacute;n: </label>
                    <input name="fecha_confirmacion" type="text" class="txt" id="fecha_confirmacion" value="<%
                        if(confirmacionBEAN.getfecha_confirmacion()!=null) 
                            out.println(confirmacionBEAN.getfecha_confirmacion());
                    %>" maxlength="10"/>
                    <button type="button" name="btn_fecha_confirmacion" id="btn_fecha_confirmacion" onclick="cal.select(document.confirmar.fecha_confirmacion,'btn_fecha_confirmacion','yyyy-MM-dd'); return false;" title="cal.select(document.confirmar.fecha_confirmacion,'btn_fecha_confirmacion','yyyy-MM-dd'); return false;"><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                </p>
            </fieldset>
	</div>
        <br>
        <div onclick="show('Solicitante')">
          <a href="#name" onclick="return false">Datos del Confirmado</a>
        </div>
        <div id="Solicitante">
            <fieldset>
              <legend>Datos del Confirmado</legend>
                ...
                <p>
                    <label for="id_sexo">Sexo: </label>
                    <label ><input name="id_sexo" type="radio" value="0" <%if (confirmacionBEAN.getconfirmado_sexo().compareTo("0") == 0) out.println("checked");%>> Femenino</label>
                    <label ><input name="id_sexo" type="radio" value="1" <%if (confirmacionBEAN.getconfirmado_sexo().compareTo("1") == 0) out.println("checked");%>> Masculino</label>
                </p>
                <p>
                  <label for="fecha_nacimiento">Fecha de Nacimiento: </label>
        ...
        <div id="Registro_eclesiastico">
            ...
            <p>
              <label for="anio_libro">A&ntilde;o: </label>
              <input type="text" name="anio_libro" id="anio_libro" class="txt" onKeyUp="onlyNumbers(this);" maxlength="4" value="<%
            ...
            <p>
              <label for="folio_libro">Folio: </label>
              <input type="text" name="folio_libro" id="folio_libro" class="txt" onKeyUp="onlyNumbers(this);" value="<%
        ...
        <div id="Observacion">
            ...
            <legend>Observaci&oacute;n</legend>
            <p align="center">
              <textarea name="observacion" cols="40" rows="4" class="txt" id="observacion" value="<%
        ...
        <br>
        <br>
        <input type="submit" name="Submit" value="    Ok    " onClick="validarIngreso();">&nbsp;&nbsp;&nbsp;
