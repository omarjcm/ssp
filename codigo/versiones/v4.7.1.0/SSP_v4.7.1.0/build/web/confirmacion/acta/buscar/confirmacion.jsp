...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="confirmacion.jsp">Buscar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; Buscar Acta de Confirmaci&oacute;n</td>
      ...
      <form name="Consultar">
        ...
        <br>
          <table width="300" border="0">
              ...
              out.println("<tr><td>");
              %>
              <a href="confirmacion_imprimir.jsp?tipo=1&id=<%=String.valueOf(solicitante.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
              ...
              <tr>
                  ...
                  for (int i = 0; i < confirmaciones.size(); i++)
                  {
                      confirmado = (SSP.Solicitante) confirmaciones.get(i);	
                                  out.println("<tr><td>");
                      %>
                      <a href="confirmacion_imprimir.jsp?id=<%=String.valueOf(confirmado.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
