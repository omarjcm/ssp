...
<html>
<head>
<title>Anulaci&oacute;n de Acta de Confirmaci&oacute;n</title>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="367" height="22" valign="top" background="../../../images/ctop.gif"><div align="center" class="style3 style1 style1">
            <h1 class="style2 style1">Anulaci&oacute;n de Acta de Confirmaci&oacute;n </h1>
          </div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../../images/ccen.gif"><form name="Anular" method="post" action="Anular_Confirmacion.jsp">
            <p>&nbsp;</p>
