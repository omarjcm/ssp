...
<table width="614" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="80" valign="top"background="../../../../images/ccen.gif"><form name="Provincia" method="post" action="Ingrese_Provincia.jsp">
            <p>&nbsp;</p>
            ...
            <p align="center">
			<a href="ciudad.jsp" target="_self"><a onclick="validarProvincia(Provincia)"style="cursor:pointer; font-weight: bold; color: #0000FF;">Aceptar</a></p>
            </form>            </td></tr>
        <tr>
