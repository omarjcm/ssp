...
<script language="JavaScript" type="text/javascript" src="valida_M.js"></script>

<html>
<head>
<title>Modificaci&oacute;n de Acta de Matrimonio</title>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="367" height="22" valign="top" background="../../../images/ctop.gif"><div align="center" class="style3 style1 style1">
            <h1 class="style2 style1">Modificaci&oacute;n de Acta de Matrimonio </h1>
          </div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../../images/ccen.gif"><form name="ModificaMatrimonio" method="post" action="ModificarM.jsp">
            <h2><br>
              Datos del esposo </h2>
            <table width="88%"  border="0" align="center">
              <tr>
                <th scope="row"><div align="right">Nombres:</div></th>
                <td><input name="esposo_nombre" id="esposo_nombre" type="text" size="30"></td>
              </tr>
              <tr>
            ...
            <h2>Datos de la esposa </h2>
            <table width="88%"  border="0" align="center">
              <tr>
                <th scope="row"><div align="right">Nombres:</div></th>
                <td><input name="esposa_nombre" id="esposa_nombre" type="text" size="30"></td>
              </tr>
              <tr>
                <th scope="row"><div align="right">Apellidos:</div></th>
                <td><div align="left">
            ...
            <p align="center"><a onclick="valida(ModificaMatrimonio)" style="cursor:pointer; font-weight: bold; color: #0000FF;">Aceptar</a></p>
            </form>            </td></tr>
        <tr>
