...
<html>
<head>
<title>Consulta de Acta de Confirmaci&oacute;n</title>
<script language="JavaScript" type="text/javascript" src="valida_C.js"></script>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="367" height="22" valign="top" background="../../../images/ctop.gif"><div align="center" class="style3 style1 style1">
            <h1 class="style2 style1">Consultar Acta de Confirmaci&oacute;n </h1>
          </div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../../images/ccen.gif"><form name="Consulta" method="post" action="Consultar_Confirmacion.jsp">
            <p>&nbsp;</p>
