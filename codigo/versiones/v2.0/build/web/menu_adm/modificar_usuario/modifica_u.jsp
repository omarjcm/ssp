...
<html>
<head>
<title>Modificaci&oacute;n de Acta de Bautizo</title>
<script language="JavaScript" type="text/javascript" src="valida_U.js"></script>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="367" height="22" valign="top" background="../../images/ctop.gif"><div align="center" class="style3 style1 style1">
            <h1 class="style2 style1">Modificar Usuario </h1>
          </div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../images/ccen.gif"><form name="Modifica" method="post" action="Buscar_Modificacion.jsp">
            <p>&nbsp;</p>
            ...
            <p align="center"><a onclick="valida(Modifica)" style="cursor:pointer; font-weight: bold; color: #0000FF;">Aceptar</p>
            </form>            </td></tr>
        <tr>
