...
LOAD TABLE "rs_systabgroup"."rs_lastcommit" ("origin", "origin_qid", "secondary_qid", "origin_time", "commit_time" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\376.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "rs_systabgroup"."rs_threads" ("id", "seq" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\377.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ul_file" ("file_id", "name", "project", "filename" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\378.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ul_statement" ("file_id", "statement_id", "line", "sql", "name", "cursor", "do_forward", "do_backward", "do_insert", "do_delete", "do_update", "code_segment" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\379.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ul_variable" ("file_id", "statement_id", "output", "sequence", "type_name", "type_length", "domain_id", "domain_length", "nulls" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\380.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ml_user" ("user_id", "name", "commit_state", "progress", "hashed_password" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\383.dat'
	DEFAULTS ON
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ml_subscription" ("user_id", "publication_name", "progress" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\384.dat'
	DEFAULTS ON
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ml_table" ("table_id", "name" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\385.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ml_script" ("script_id", "script", "script_language" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\386.dat'
	DEFAULTS ON
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ml_script_version" ("version_id", "name", "description" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\387.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ml_connection_script" ("version_id", "event", "script_id" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\388.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."ml_table_script" ("version_id", "table_id", "event", "script_id" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\389.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."migrate_remote_table_list" ("table_id", "server_name", "database_name", "owner_name", "table_name", "table_type", "created_proxy", "created_real", "dropped", "data_migrated" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\392.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."migrate_sql_defn" ("id", "unld_str", "et_table_id" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\393.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "dbo"."migrate_remote_fks_list" ("fk_id", "pk_database", "pk_owner", "pk_table", "pk_column", "fk_database", "fk_owner", "fk_table", "fk_column", "key_seq", "fk_name", "pk_name", "created" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\394.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Registro_Civil" ("id_rc", "fecha_nacimiento", "fecha_inscripcion", "tomo", "anio", "folio", "acta", "lugar" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\409.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Ciudad" ("id_ciudad", "nombre", "id_provincia" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\410.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Provincia" ("id_provincia", "nombre" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\411.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Parroquia" ("id_parroquia", "nombre", "direccion", "telefono1", "telefono2", "telefono3", "id_ciudad" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\412.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Solicitante" ("id_solicitante", "nombre", "apellido", "direccion", "sexo", "tipo", "id_ciudad", "id_usuario" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\413.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Confirmar" ("id_confirmacion", "id_confirmacion_libro", "num_libro", "folio_libro", "anio_libro", "fecha_confirmacion", "ciudad_bautizo", "iglesia_bautizo", "observacion", "estado", "id_confirmado", "id_padre", "id_madre", "id_padrino", "id_madrina", "id_parroquia", "id_ministro", "fecha_nacimiento" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\414.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Usuario" ("id_usuario", "clave", "usuario", "nombre", "apellido", "tipo_usuario", "cargo", "direccion", "telefono1", "telefono2", "id_ciudad", "id_parroquia", "estado" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\415.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Casar" ("id_matrimonio", "id_matrimonio_libro", "num_libro", "folio_libro", "anio_libro", "fecha_matrimonio", "observacion", "estado", "id_esposo", "id_esposa", "id_padre_esposo", "id_madre_esposo", "id_padre_esposa", "id_madre_esposa", "id_padrino", "id_madrina", "id_parroquia", "id_rc", "id_ministro" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\416.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."Bautizar" ("id_bautizo", "id_bautizo_libro", "num_libro", "folio_libro", "anio_libro", "fecha_bautizo", "observacion", "estado", "id_bautizado", "id_padre", "id_madre", "id_padrino", "id_madrina", "id_parroquia", "id_rc", "id_ministro" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\417.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
go
LOAD TABLE "DBA"."ComulgarxPrimeraVez" ("id_comunion", "id_comunion_libro", "num_libro", "folio_libro", "anio_libro", "fecha_comunion", "edad", "estadoCivilPadres", "name_institucion", "nivel", "observacion", "estado", "id_comulgado", "id_padre", "id_madre", "id_padrino", "id_madrina", "id_ministro", "id_parroquia" )
	FROM 'C:\\Documents and Settings\\Guillermo Pizarro\\Desktop\\ProyectoSSP\\SOURCE\\v2.1\\ssp_db_2.0\\418.dat'
	FORMAT 'ASCII' QUOTES ON
	ORDER OFF ESCAPES ON
	CHECK CONSTRAINTS OFF COMPUTES OFF
	STRIP OFF DELIMITED BY ','
