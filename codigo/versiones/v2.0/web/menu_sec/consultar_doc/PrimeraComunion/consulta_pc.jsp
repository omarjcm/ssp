...
<html>
<head>
<title>Consulta de Acta de Primera Comuni&oacute;n</title>
<script language="JavaScript" type="text/javascript" src="valida_Comunion.js"></script>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="367" height="22" valign="top" background="../../../images/ctop.gif"><div align="center" class="style3 style1 style1">
            <h1 class="style2 style1">Consultar Acta de Primera Comuni&oacute;n </h1>
          </div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../../images/ccen.gif"><form name="Consulta" method="post" action="Consultar_Comunion.jsp">
            <p>&nbsp;</p>
            ...
            <p align="center"><a href="../bautizo.jsp"><a onclick="valida(Consulta)" style="cursor:pointer; font-weight: bold; color: #0000FF;">Aceptar</a></p>
            </form>            </td></tr>
        <tr>
