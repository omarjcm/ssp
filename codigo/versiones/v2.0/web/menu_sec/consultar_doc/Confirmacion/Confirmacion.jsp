...
<table width="72%" height="190"  border="0" align="center">
  ...
  <% out.println(confirBEAN.getId_confirmacion());%>
            ...
            <th scope="col"><h3 align="left">  El suscrito 
              <% out.println(confirBEAN.getMinistro_cargo()+" "+confirBEAN.getMinistro_nombre()+" "+confirBEAN.getMinistro_apellido());%>
              <br>
...
%> 
  ...
  <tr>
    <th scope="row"><h3><a href="../../menu/sec_menu_C.jsp"><strong><br>
  Aceptar</strong></a></h3></th>
  </tr>
</table>
