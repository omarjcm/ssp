...
<html>
<head>
<title>Modificaci&oacute;sn exitoso de Acta de Primera Comuni&oacute;n</title>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="367" height="22" valign="top" background="../../../images/ctop.gif"><div align="center" class="style3">
            <h1 class="style1">MENSAJE</h1>
          </div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../../images/ccen.gif"><p>&nbsp;</p>            <table width="91%"  border="0" align="center">
            <tr>
              <th scope="col"><h2>Se modific&oacute;<br>                
                  ACTA DE PRIMERA COMUNI&Oacute;N<br>
                con &eacute;xito</h2></th>
            </tr>
          </table>
          <h2 align="center"><a href="modifica_pc.jsp">OK</a></h2>
          <p align="center">&nbsp;</p></td>
        </tr>
        <tr>
