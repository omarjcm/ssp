...
<html>
<head>
<title>Modificaci&oacute;n fallida de Acta de Primera Comuni&oacute;n</title>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="80" valign="top"background="../../../images/ccen.gif"><p>&nbsp;</p>            <table width="91%"  border="0" align="center">
            <tr>
              <th scope="col"><h2>Solicitante no encontrado<br>
                en
                <br>
                  ACTA DE PRIMERA COMUNI&Oacute;N</h2></th>
            </tr>
          </table>
