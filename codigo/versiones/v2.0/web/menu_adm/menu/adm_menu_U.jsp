...
<table width="614" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td width="367" height="22" valign="top" background="../../images/ctop.gif"><div align="center"><span class="style3 style1">USUARIO</span></div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../images/ccen.gif"><h5 align="center"><br>
              <a href="ingresos/menu_U_ingreso.htm" target="_parent">Ingresar</a><br>
              <a href="modificaciones/menu_U_modificaciones.htm" target="_parent">Modificar</a><br>
              <a href="anulaciones/menu_U_anula.htm" target="_parent">Anular</a><br>
              <br>
</h5></td>
        </tr>
        <tr>
