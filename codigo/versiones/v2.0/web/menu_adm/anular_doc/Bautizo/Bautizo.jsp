    ...
    <th scope="row"><table width="614" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="2" valign="top"><h5 align="left">El infrascrito
                <% out.println(bBEAN.parroco.getCargo()+" "+bBEAN.parroco.getNombre()+" "+bBEAN.parroco.getApellido());%>
                <br>
...
%>
        ...
        .</h5>
            ...
            <h3 align="left">NOTA: El documento Bautizo se encuentra en estado NULO</h3>
            
      </tr>
    </table></th>
  </tr>
  <tr>
    <th scope="row"><h3><a href="../../menu/adm_menu_B.jsp"><strong><br>
