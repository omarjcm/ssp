...
<html>
<head>
<title>Consulta de Acta de Matrimonio</title>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="367" height="22" valign="top" background="../../../images/ctop.gif"><div align="center" class="style3 style1 style1">
            <h1 class="style2 style1">Anulaci&oacute;n de Acta de Matrimonio </h1>
          </div></td>
        </tr>
        <tr>
          <td height="80" valign="top"background="../../../images/ccen.gif"><form name="AnulaMatrimonio" method="post" action="Anular_Matrimonio.jsp">
            <h2><br>
              Datos del esposo </h2>
            ...
            <p align="center"><a onclick="valida(AnulaMatrimonio)"style="cursor:pointer; font-weight: bold; color: #0000FF;">Aceptar</a></p>
            </form>            </td></tr>
        <tr>
