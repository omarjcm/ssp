...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Anular Acta de Confirmaci&oacute;n </span> </td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>ANULAR  ACTA DE CONFIRMACI&Oacute;N </strong></a><br>
            <br>
            <fieldset>
