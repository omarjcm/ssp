...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="comunion.jsp">Buscar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Buscar Acta de Primera Comuni&oacute;n</span></td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>BUSCAR  ACTA DE PRIMERA COMUNI&Oacute;N </strong></a><br>
            <br>
            <fieldset>
