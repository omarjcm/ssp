...
<html>
    <head>
        ...
        <title>SSP - Anulaci&oacute;n Acta de Primera Comuni&oacute;n</title>
...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="comunion.jsp">Anular Acta</a>			<br>			
                <%
		}
	}
%></td>
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Anulaci&oacute;n de Acta de Primera Comuni&oacute;n</span> </td>
      ...
      <tr>
          <td width="580" height="321" align="center" valign="top">			
              ...
              <div id="container">
                      <form name="Anular" method="post" action="comunionBEAN.jsp">
                        <span><strong>ANULACI&Oacute;N DE ACTA DE PRIMERA COMUNI&Oacute;N</strong></span><br>
                        <br>
                        <fieldset>
                            <legend>Datos Personales del Solicitante</legend>
                            <p>
                                <label>Nombre(s):</label>
                                <label><%out.println(comunionBEAN.getcomulgado_nombre());%></label>
                            </p>
                            <p>
                                <label>Apellido(s):</label>
                                <label><%out.println(comunionBEAN.getcomulgado_apellido());%></label>
                            </p>
                            <p>
                                <label>Fecha de Bautizo:</label>
                                <label><%out.println(comunionBEAN.getfecha_comunion());%></label>
                            </p>
                            <p>
                                <label>Estado del Acta:</label>
                                <label><% if(comunionBEAN.getEstado()) out.println("Habilitada"); else out.println("Inhabilitada");%></label>
                            </p>
                        </fieldset>
                        <br>
	  		<br>
