...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="comunion.jsp">Anular Acta</a>			
                <br>
<%
		}
	}
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Anular Acta de Primera Comuni&oacute;n </span> </td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>ANULAR  ACTA DE PRIMERA COMUNI&Oacute;N </strong></a><br>
            <br>
            <fieldset>
        ...
        <form name="PorNombreApellido" method="post" action="comunion_01aBEAN.jsp">
        ...
        <form name="PorFecha" method="post" action="comunion_01bBEAN.jsp">        
