...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="7" height="7"> <a href="../modificar/comunion.jsp">Buscar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%
      ...
      <tr>
          <td width="580" height="321" align="center" valign="top">			
              ...
              <div id="container">
                      ...
                      LinkedList bautizos = comunionBEAN.generarComunionFecha(comunionBEAN.getfecha_comunion(),"comunion");
                      for (int i = 0; i < bautizos.size(); i++)
                      {
                      bautizado = (SSP.Solicitante) bautizos.get(i);		
                                  out.println("<tr><td>");
                      %>
                      <a href="comunion_02b.jsp?id=<%=String.valueOf(bautizado.getIdSolicitante())%>">
