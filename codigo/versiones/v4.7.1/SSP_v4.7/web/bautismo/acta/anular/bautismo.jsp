...
%>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="bautismo.jsp">Anular Acta</a>			<br>						<%
		}
	}
%>
</td>
...
%>		  
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Anular Acta de Bautizo</span> </td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>ANULAR  ACTA DE BAUTIZO</strong></a><br>
            <br>
            <fieldset>
        ...
        <form name="PorNombreApellido" method="post" action="por_nombre_apellidoBEAN.jsp">
