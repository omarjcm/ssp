          ...
          <td width="580" height="321" align="center" valign="top">			
	  		...
	  		<br>
                      ...
                      bautizado = (SSP.Solicitante) bautizos.get(i);		
                                  out.println("<tr><td>");
                      %>
                      <a href="bautismoBuscar_por_fecha.jsp?id=<%=String.valueOf(bautizado.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
