...
%>
		...
		{
%>
                <img src="../../../imagenes/add.png" width="8" height="7"> <a href="bautismo.jsp">Modificar Acta</a>			<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Modificar Acta de Bautizo</span> </td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>MODIFICAR ACTA DE BAUTIZO</strong></a><br>
            <br>
            <fieldset>
