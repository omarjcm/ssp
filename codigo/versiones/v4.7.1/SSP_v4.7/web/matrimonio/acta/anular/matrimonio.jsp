...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Anular Acta de Matrimonio </span> </td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>ANULAR  ACTA DE MATRIMONIO </strong></a><br>
            <br>
            <fieldset>
              ...
              <tr>
                ...
                <fieldset>
                  <legend>B&uacute;squeda por fecha</legend>
                    <p>
                        <label for="fecha_bautizo">Fecha de Matrimonio: </label>
