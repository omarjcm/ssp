...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Buscar Acta de Matrimonio </span></td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>BUSCAR  ACTA DE MATRIMONIO </strong><br>
            <br>
            <fieldset>
