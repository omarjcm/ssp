...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Buscar Acta de Confirmaci&oacute;n</span></td>
      ...
      <div id="container">
        <form name="ninguno">
            <strong>BUSCAR  ACTA DE CONFIRMACI&Oacute;N </strong></a><br>
            <br>
            <fieldset>
              ...
              <tr>
                ...
                <fieldset>
                  <legend>B&uacute;squeda por fecha</legend>
                    <p>
                        <label for="fecha_bautizo">Fecha de Confirmaci&oacute;n: </label>
