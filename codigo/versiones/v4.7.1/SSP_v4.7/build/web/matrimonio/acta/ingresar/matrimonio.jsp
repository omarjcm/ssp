...
%>		  
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Ingreso de Acta de Matrimonio</span> </td>
	...
	<div id="solicitante">
            ...
            <tr>
            <td height="251" colspan="6" valign="top">
            <span id="titulo">Paso 2 de 8</span>
                <fieldset>
        ...
        <div id="padres_esposo">
            ...
            <tr>
            <td height="251" colspan="6" valign="top">
            <span id="titulo">Paso 3 de 8</span>
              <fieldset>
        ...
        <div id="padres_esposa">
            ...
            <tr>
            <td height="251" colspan="6" valign="top">
            <span id="titulo">Paso 4 de 8</span>
              <fieldset>
        ...
        <div id="padrinos">
            ...
            <tr>
            <td height="251" colspan="6" valign="top">
            <span id="titulo">Paso 5 de 8</span>
		<fieldset>
        ...
        <div id="reg_eclesiastico">
          <table width="449" height="278" border="0" cellpadding="0" cellspacing="0">
            <tr>
            <td height="251" colspan="6" valign="top">
            <span id="titulo">Paso 6 de 8</span>
            <fieldset>
	...
	<div id="reg_civil">
          <table width="449" height="278" border="0" cellpadding="0" cellspacing="0">
            <tr>
            <td height="251" colspan="6" valign="top">
            <span id="titulo">Paso 7 de 8</span>
            <fieldset>
        ...
        <div id="txt_observacion">
          <table width="449" height="278" border="0" cellpadding="0" cellspacing="0">
            <tr>
            <td height="251" colspan="6" valign="top">
            <span id="titulo">Paso 8 de 8</span>
                <fieldset>
