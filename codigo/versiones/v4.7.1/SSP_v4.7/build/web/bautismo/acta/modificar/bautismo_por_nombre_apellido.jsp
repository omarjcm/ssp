...
<html>
    <head>
        ...
        <title>SSP - Modificación Acta de Bautizo</title>
...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Modificaci&oacute;n de Acta de Bautizo</span> </td>
      ...
      <tr>
              <td width="580" height="321" align="center" valign="top">			
                  ...
                  <div id="container">
                      <form name="Consultar">
                          <span><strong>MODIFICACI&Oacute;N DE ACTA DE BAUTIZO</strong></span><br>
                          <br>
	  		<br>
                          ...
                          <%
                              ...
                              for (int i = 0; i < solicitanteList.size(); i++)
                              {
                                  ...
                                  out.println("<tr><td>");
                          %>
                                  <a href="bautismoModificar_por_nombre_apellido.jsp?id=<%=String.valueOf(solicitante.getIdSolicitante())%>">
