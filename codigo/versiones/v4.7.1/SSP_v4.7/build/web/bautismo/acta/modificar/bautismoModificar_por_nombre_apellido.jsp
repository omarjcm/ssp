...
<html>
    <head>
        ...
        <title>SSP - Modificaci&oacute;n de Acta de Bautizo</title>
        ...
        <script language="JavaScript" type="text/javascript" src="bautismoModificar.js"></script>		
...
%>
      ...
      <form name="Bautizo" method="post" action="bautismoModificarBEAN.jsp">
        <strong>MODIFICACI&Oacute;N DE ACTA DE BAUTIZO</strong><br>
		<br>
        <br>
