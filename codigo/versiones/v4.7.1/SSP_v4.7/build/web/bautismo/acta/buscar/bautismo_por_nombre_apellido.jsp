...
%>
		  ...
		  <p>&nbsp;</p>
        <p>&nbsp;</p></td>
        <td width="512" height="40" valign="middle"><a href="../../../inicio/index.jsp">Inicio</a> &gt; <span id="titulo">Buscar Acta de Bautizo</span> </td>
      ...
      <tr>
              <td width="580" height="321" align="center" valign="top">			
                  ...
                  <div id="container">
                      <form name="Consultar">
                          <span><strong>BUSCAR  ACTA DE BAUTIZO</strong></span><br><br>
	  		<br>
                          ...
                          <%
                              ...
                              for (int i = 0; i < solicitanteList.size(); i++)
                              {
                                  ...
                                  out.println("<tr><td>");
                          %>
                                  <a href="bautismoBuscar_por_nombre_apellido.jsp?id=<%=String.valueOf(solicitante.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'width=650,height=550'); return false;">
