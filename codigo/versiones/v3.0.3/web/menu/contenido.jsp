...
<table width="550" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="397"><table width="367" border="0" align="center" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="369" height="22" align="center" valign="middle" background="../imagenes/ctop.gif"><div align="center"><strong><span class="style2">
          <% 
      ...
      <tr>
        <td height="34" align="center" valign="middle"background="../imagenes/ccen.gif"><h5 align="center"><br>
            <% out.print(uBEAN.getCargo()+" "+uBEAN.getNombre()+" "+uBEAN.getApellido()); %>
        </h5></td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="30" colspan="3" align="center" valign="middle"background="../imagenes/spacer_down.gif"><div align="center">      
        &quot;Sistemas de Servicios Parroquiales&quot; (SSP)</div></td>
  </tr>
</table>
</body>
</html>
