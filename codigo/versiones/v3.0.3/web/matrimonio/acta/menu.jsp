...
<html>
<head>
<title>Men&uacute; de Acta de Matrimonio</title>
...
<table width="550" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="397"><table width="367" border="0" align="center" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="369" height="22" align="center" valign="middle" background="../../imagenes/ctop.gif"><div align="center"><span class="style2">ACTA DE MATRIMONIO</span></div></td>
      </tr>
      <tr>
    ...
    {
%>
                  <a href="ingresar/matrimonio.jsp" target="_self">Ingresar</a><br>
                  <%
	}
    if( uBEAN.esAdministrador() )
    {
%>
                  <a href="modificar/matrimonio.jsp" target="_self">Modificar</a><br>
                  <a href="anular/matrimonio.jsp" target="_self">Anular</a><br>
                  <%
	}
	if ( uBEAN.esAdministrador() || uBEAN.esSecretario() )
	{
%>
                  <a href="consultar/matrimonio.jsp" target="_self">Consultar</a> <br>
                  <%
	}
%>
        </h5></td>
