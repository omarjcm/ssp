...
nomB_ VARCHAR(50), apeB_ VARCHAR(50), sexoB_ BOOLEAN,
nomP_ VARCHAR(50), apeP_ VARCHAR(50),
nomM_ VARCHAR(50), apeM_ VARCHAR(50),
nomPa_ VARCHAR(50), apePa_ VARCHAR(50), nomMa_ VARCHAR(50), apeMa_ VARCHAR(50),
tomo_ VARCHAR(50), anio_ VARCHAR(50),
folio_ VARCHAR(50), acta_ VARCHAR(50), id_ministro BIGINT,
...
BEGIN
  ...
  ELSE
    ...
    ELSE
     ...
     --   BEGIN
        #Ingresa bautizado
        CALL ssp_ingresar_solicitante(nomB_, apeB_, '', null, '', '', sexoB_, null, null, '', '', 'bautizado', salida);
