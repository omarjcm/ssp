...
nombre_institucion_ VARCHAR(50), grado_ VARCHAR(50),
...
BEGIN
  ...
  ELSE
      ...
      ELSE
        ...
        #Ingresa comulgado
        CALL ssp_ingresar_solicitante(nomCom_, apeCom_, '', edadCom_, '', '', sexoCom_, null, null, '', '', 'comulgado', salida);
        ...
        CALL ssp_ingresar_solicitante(nomP_, apeP_, '', null, '', '', null, null, null, '', '', 'padre', salida);
        #Ingresa madre del comulgado
        CALL ssp_ingresar_solicitante(nomM_, apeM_, '', null, '', '', null, null, null, '', '', 'madre', salida);
        #Ingresa padrino del comulgado
        CALL ssp_ingresar_solicitante(nomPa_, apePa_, '', null, '', '', null, null, null, '', '', 'padrino', salida);
        #Ingresa madrina del comulgado
        CALL ssp_ingresar_solicitante(nomMa_, apeMa_, '', null, '', '', null, null, null, '', '', 'madrina', salida);
        ...
        INSERT INTO comulgarporprimeravez(fecha_comunion, estado_civil_padres, nombre_institucion, grado, lugar_comunion, observacion, estado, id_comulgado, id_padre, id_madre, id_padrino, id_madrina, id_ministro, id_usuario, id_registro_eclesiastico)
	      VALUES (fecha_comunion, estado_civil_padres_, nombre_institucion_, grado_, lugar_comunion_, observacion_, 1, id_comulgado, id_padre, id_madre, id_padrino, id_madrina, id_ministro_, id_usuario, id_registro_eclesiastico);
