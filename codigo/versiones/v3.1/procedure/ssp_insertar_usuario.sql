...
nombre_ VARCHAR(50), apellido_ VARCHAR(50), direccion_ VARCHAR(50),
sexo_ VARCHAR(50), lugar_nacimiento_ VARCHAR(50), tipo_ VARCHAR(50),
cargo_ VARCHAR(50), telefono1_ VARCHAR(50), telefono2_ VARCHAR(50),
usuario_ VARCHAR(50), contrasenia_ VARCHAR(50), id_administrador_ BIGINT,
