...
<html>
<head>
<title>Men&uacute; de Acta de Confirmaci&oacute;n</title>
...
<table width="550" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="397"><table width="367" border="0" align="center" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="369" height="22" align="center" valign="middle" background="../../imagenes/ctop.gif"><div align="center"><span class="style2">ACTA DE CONFIRMACI&Oacute;N </span></div></td>
      </tr>
      <tr>
    ...
    {
%>
                  <a href="ingresar/confirmacion.jsp" target="_self">Ingresar</a><br>
                  <%
	}
    if( uBEAN.esAdministrador() )
    {
%>
                  <a href="modificar/confirmacion.jsp" target="_self">Modificar</a><br>
                  <a href="anular/confirmacion.jsp" target="_self">Anular</a><br>
                  <%
	}
	if ( uBEAN.esAdministrador() || uBEAN.esSecretario() )
	{
%>
                  <a href="consultar/confirmacion.jsp" target="_self">Consultar</a> <br>
                  <%
	}
%>
        </h5></td>
