...
<table width="550" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    {
%>
            <a href="ingresar/bautismo.jsp" target="_self">Ingresar</a><br>
            <%
	}
    if( uBEAN.esAdministrador() )
    {
%>
            <a href="modificar/bautismo.jsp" target="_self">Modificar</a><br>
            <a href="anular/bautismo.jsp" target="_self">Anular</a><br>
            <%
	}
	if ( uBEAN.esAdministrador() || uBEAN.esSecretario() )
	{
%>
            <a href="consultar/menu_bautismo.jsp" target="_self">Consultar</a> <br>
            <%
	}
%>
        </h5></td>
