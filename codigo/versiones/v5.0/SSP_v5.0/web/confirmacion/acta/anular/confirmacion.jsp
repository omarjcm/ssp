...
%></td>
        ...
        %>
        Anular Acta de Confirmaci&oacute;n</span> </td>
...
%>
        ...
        <form name="PorFecha" method="post" action="confirmacion_02BEAN.jsp" onSubmit="buscarPorFecha(); return false;">        <div id="buscar_por_fecha">
