...
<%
    ...
    // Fecha
    registroBEAN.parsingFecha(fecha_.toString());
    int mes = java.lang.Integer.parseInt(registroBEAN.getFecha_mes());
    String fecha_mes = registroBEAN.mostrarMes(mes);
    String fecha_anio = registroBEAN.getFecha_anio();
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr valign="middle">
                <td align="center" class="header_sub_titulo_03"><%=fecha_mes%> - <%=fecha_anio%></td>
            </tr>
