                ...
                <td height="251" colspan="6" valign="top">
                    ...
                    <fieldset>
                        ...
                        <p>
                            ...
                            <button type="button" name="btn_anio_libro" id="btn_anio_libro" onclick="cal_anio_01a.showCalendar('btn_anio_libro'); return false;" title="Haga click aqu&iacute; para ingresar el a&ntilde;o del Libro de Primera Comuni&oacute;n."><img src="../../../imagenes/Calendar.gif" border="0"/></button>
                        </p>
                        <p>
...
<form name="comunion" method="post" action="comunionIngresarBEAN.jsp">
    ...
    <div id="cont_solicitante_01">
        ...
        <table width="238" border="0">
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="2"><label><input name="id_sexo" type="radio" value="0" <%if (comunionBEAN.getcomulgado_sexo().compareTo("0") == 0) out.println("checked");%>> Femenino</input></label>
                <label><input name="id_sexo" type="radio" value="1" <%if (comunionBEAN.getcomulgado_sexo().compareTo("1") == 0) out.println("checked");%>> Masculino</input></label></td>
            </tr>
            <tr>
