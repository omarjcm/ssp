                        ...
                        <form name="bautismo" method="post" action="bautismoIngresarBEAN.jsp">
                            ...
                            <div id="cont_solicitante">
                                ...
                                <table width="238" border="0">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td colspan="2"><label><input name="id_sexo" type="radio" value="0" <%if (bautizoBEAN.getbautizado_sexo().compareTo("0") == 0) out.println("checked");%>> Femenino</input></label>
                                        <label><input name="id_sexo" type="radio" value="1" <%if (bautizoBEAN.getbautizado_sexo().compareTo("1") == 0) out.println("checked");%>>  Masculino</input></label></td>
                                    </tr>
                                    <tr>
