var mensaje_01 = "¿Está seguro de volver a iniciar la anulación del Acta de Bautizo?";
var mensaje_02 = "¿Está seguro de cancelar la anulación del Acta de Bautizo?";
...
{
	var valor = confirm("¿Se encuentra seguro de anular el Acta de Bautizo?");
	if (valor) {
		Anular.submit();
	}
}
