...
%>
                ...
                <%
                    if (id.compareTo("1") == 0)
                        out.println("href=\"../modificar/comunion.jsp?id=1\"");
                    else
                        out.println("href=\"#\" onClick=\"cambiar('../modificar/comunion.jsp?id=1', mensaje_02)\"");
                %> >Modificar Acta</a>
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../../../imagenes/add.png" width="8" height="7"> <a
...
%>
        Buscar Acta de Primera Comuni&oacute;n</span></td>
...
<%
              ...
              for (int i = 0; i < solicitanteList.size(); i++)
              {
                  ...
                  <a href="comunion_imprimir.jsp?id=<%=String.valueOf(solicitante.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'left=200, top=50,width=650,height=550,scrollbars=YES,menubar=yes'); return false;">
          ...
          <table width="300" border="0" class="datatable">
              <tr>
                  ...
                  for (int i = 0; i < comuniones.size(); i++)
                  {
                      ...
                      out.println("<tr><td> "+String.valueOf(i+1)+". "); %>
                      <a href="comunion_imprimir.jsp?id=<%=String.valueOf(comulgado.getIdSolicitante())%>" target="popup" onClick="window.open(this.href, this.target, 'left=200, top=50,width=650,height=550,scrollbars=YES,menubar=yes'); return false;">
