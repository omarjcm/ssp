...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr valign="middle">
                <td align="center" class="header_sub_titulo_03">
                    <% if (inicio_anio.compareTo(fin_anio)==0) 
                        out.println(inicio_mes+" a "+fin_mes+" - "+fin_anio);
                       else
                        out.println(inicio_mes+"-"+inicio_anio+" a "+fin_mes+"-"+fin_anio); %>
                </td>
            </tr>
            <tr>
