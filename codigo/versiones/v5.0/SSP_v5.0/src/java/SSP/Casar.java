 ...
 *   4.6        Stephanie Flores   15/07/07  Ingresar Bautizo
 *   4.7        Stephanie Flores   20/07/07  Modificar Bautizo
 *   4.7        Stephanie Flores   20/07/07  Anular Bautizo
 * ==============================================================
 *
 */
...
public class Casar{
    ...
    /**
     * identifica al acta de matrimonio
     *
     * <p>requisito: RD-MD.1.4
     */
    
    /**
     * Muestra el identificador del acta de matrimonio.
     */
    ...
    /**
     * Muestra los datos del objeto solicitante pa_esposo.
     */
    public Solicitante pa_esposo;
    /**
     * Muestra los datos del objeto solicitante ma_esposo.
     */
    public Solicitante ma_esposo;
    /**
     * Muestra los datos del objeto solicitante pa_esposa.
     */
    public Solicitante pa_esposa;
    /**
     * Muestra los datos del objeto solicitante ma_esposa.
     */
    ...
    /**
     * Muestra los datos del objeto registro civil.
     */
    public RegistroCivil rc;
    /**
     * Muestra los datos del objeto registro eclesiantico.
     */
    public RegistroEclesiastico re;
    /**
     * Muestra el identificador del ministro.
     */
    public String id_ministro;
    /**
     * Muestra el nombre de los padrinos.
     */
    ...
    public ResultSet rs;
    /**
     * Muestra el dia de matrimonio.
     */
    public String dia_matrimonio;
    /**
     * Muestra el mes de matrimonio.
     */
    public String mes_matrimonio;
    /**
     * Muestra el año de matrimonio.
     */
    public String anio_matrimonio;
    
    /*CONSTRUCTORES*/
    /**
     * Constructor que crea una instancia Casar.
     * <p>requisito: RD-MD.1.4
     */
    ...
    public boolean ingresarMatrimonio(long id_usuario_) throws SQLException{
        ...
        if(con!=null){
            try{
                ...
                cst.setDate(31, (Date) getFechaInscripcion());
                cst.registerOutParameter(32,java.sql.Types.CHAR);
                rs=cst.executeQuery();
                con.close();
            }
  ...
  /**
  * Consulta el acta de matrimonio deseada
  *
  * <p>Referencia DDS:
  * <p>Invariantes:    fecha_matrimonio
  ...
  * @return 		void
  */
    public void consultarMatrimonio(String id)throws Exception{
        rs = null;
        if(cnx.conectar()) con= cnx.getConexion();
        ...
        if(con!=null){
            try{
                ...
                while(rs.next()){
                    ...
                    rc.setFechaInscripcion(rs.getDate(44));
                }
               }
            catch(SQLException e){
                setMensaje_error(e.getMessage());
    ...
    /**
    * Modifica o actualiza los datos del acta de matrimonio
    * <p>Referencia DDS:
    * <p>Invariantes:       fecha_matrimonio
    * <p>Precondiciones:    Ingresar Acta Matrimonio
    * <p>Poscondiciones: 
    ...
    public boolean modificarMatrimonio(long id_usuario_) throws SQLException{
        ...
        if(con!=null){
            try{
                ...
                cst.setDate(42, (Date) rc.getFechaInscripcion());
                cst.registerOutParameter(43,java.sql.Types.CHAR);
                cst.executeUpdate();
                setMensaje_error(cst.getString(43));
                con.close();
                return true;
            }
            catch(SQLException e){
  ...
  /**
  * Genera la lista de los casados en la fecha ingresada
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Ingresar Acta de matrimonio
  * <p>Poscondiciones:
  * @param fecha		Fecha matrimonio
  ...
  */
    public LinkedList generarMatrimonioFecha(String fecha, String tipo_doc)throws Exception{
        ...
        if(con!=null){
            try{
                ...
                {
                    esposos = new Esposos();
                    esposos.setId_matrimonio(rs.getLong(1));
                    esposos.getEsposo().setNombre(rs.getString(4));
                    esposos.getEsposo().setApellido(rs.getString(5));
                    esposos.getEsposa().setNombre(rs.getString(6));
                    esposos.getEsposa().setApellido(rs.getString(7));
                    
                    matrimonios_fecha.add((Esposos) esposos);
                }
                rs.close();
                con.close();
  ...
  /**
  * Genera la lista de los esposos
  * 
  * <p>Referencia DDS:
  * <p>Invariantes:
  * <p>Precondiciones: Ingresar Acta
  * <p>Poscondiciones:
  * @return 			LinkedList
  */
    public LinkedList listaDeEsposos() throws Exception {
        LinkedList espososList = new LinkedList();
        Esposos esposos;
        ...
        if(con!=null) {
            try {
                ...
                cst.setString(1, esposo.getNombre());
                cst.setString(2, esposo.getApellido());
                cst.setString(3, esposa.getNombre());
                cst.setString(4, esposa.getApellido());
                rs = cst.executeQuery();
                while (rs.next())
                {
                    esposos = new Esposos();
                    esposos.setId_matrimonio(rs.getLong(1));
                    esposos.getEsposo().setNombre(rs.getString(2));
                    esposos.getEsposo().setApellido(rs.getString(3));
                    esposos.getEsposa().setNombre(rs.getString(4));
                    esposos.getEsposa().setApellido(rs.getString(5));
                    espososList.add((Esposos) esposos);
                }
                rs.close();
                return espososList;
            }
